...
**Pre-alpha (v0.1.0).** Scaffold only — nothing works yet.
...
|---|---|
| **M1** | `email:provide` claimed; `email:deliver` hook sends via Cloudflare Email Service binding. Prove outbound works. |
| **M2** | Inbound via Cloudflare Email Worker; basic list-view admin page. |
| **M3** | Inbox-by-Google UX: card-based list, pin / snooze / done. |
| **M4** | Bundle classification (Orders, Shipping, Commissions, Fans, Promos, Updates). |
